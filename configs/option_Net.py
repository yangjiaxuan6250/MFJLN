...
class parser_args(TaskDispatcher, name='Net'):
    ...
    def __init__(self, cfg=None):
        ...
        # * Model and Dataset
        parser.add_argument('--arch', '-a', metavar='ARCH', default='Net', type=str)
        parser.add_argument('--dataset', default={'train': 'Rain200H', 'val': 'Rain200H'}, type=str,
                            choices=['Rain200L', 'Rain100L', 'Rain200H', 'Rain100H',
                                     'test12', 'real', 'DID', 'SPA', 'DDN', 'GT-RAIN'],
                            help="Datasets")
