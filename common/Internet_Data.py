...
class Intertnet_Dataset(udata.Dataset):
    def __init__(self, data_path, patch_size, eval):
        super(Intertnet_Dataset, self).__init__()
        # train
        print('process training data')
        self.input_path = os.path.join(data_path, 'real_input')
        self.target_path = self.input_path
...
if __name__ == '__main__':
    ...
    dataset = Intertnet_Dataset(data_path, (128, 128), False)
    print(dataset[0])
